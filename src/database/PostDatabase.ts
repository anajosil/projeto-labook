import { LikeDislikeDB, POST_LIKE, PostDB, PostDBAndCreator } from "../models/Post";
...
export class PostDatabase extends BaseDatabase{
   ...
   public getPostsAndCreator = async (): Promise<PostDBAndCreator[]> => {
    ...
    return result as PostDBAndCreator[]
   }
...
public deletePostById = async(id:string): Promise<void> => {
   ...
   public findPostWithCreatorNameById = async (id: string): Promise<PostDBAndCreator | undefined> => {
    ...
    return result as PostDBAndCreator | undefined
   }



   public findLikeDislike = async (likeDislikeDB : LikeDislikeDB): Promise< POST_LIKE | undefined> => {
    const [likeDislike] : Array<LikeDislikeDB | undefined> = await BaseDatabase
